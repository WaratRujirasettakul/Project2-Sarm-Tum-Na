...
public class Code_Corruptedmonk : MonoBehaviour
{
    ...
    void animate()
    {
        if (acount.gameObject.GetComponent<Code_Corruptedmonkattack>().attackcount == 1)
        {
            //print("count1");
            if (acount.gameObject.GetComponent<Code_Corruptedmonkattack>().attacklist < 2)
            {
                print("count2");
                idle = false;
                attack = true;
            }
            else if (acount.gameObject.GetComponent<Code_Corruptedmonkattack>().attacklist == 2)
            {
                print("count3");
                idle = false;
                attack = false;
        ...
        else if (acount.gameObject.GetComponent<Code_Corruptedmonkattack>().attackcount == 0)
        {
            idle = true;
            attack = false;
            attack2 = false;
